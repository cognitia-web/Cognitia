        ...
        <div class="footer-top">
          ...
          <div class="footer-brand">
            ...
            <p class="brand-tagline">
              Empowering students to achieve their academic goals with AI-powered productivity tools.
            </p>
            <!-- Social Links -->
          ...
          <div class="footer-links">
            <div *ngFor="let section of footerSections" class="link-section">
  ...
  socialLinks: SocialLink[] = [
    {
      ...
      url: 'https://twitter.com/cognitia',
      color: '#1DA1F2'
    },
    {
      name: 'GitHub',
    ...
    },
    {
      ...
      url: 'https://instagram.com/cognitia',
      color: '#E4405F'
    }
  ];
}
